...
[TOOL_CALL:browser_assert(type="text_contains", selector="h1", expected="Welcome")]
[TOOL_CALL:browser_wait(type="element_visible", selector=".modal", timeout=5000)]
[TOOL_CALL:browser_eval(expression="document.title")]
